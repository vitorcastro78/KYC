...
internal static class KycExecutiveSummaryBuilder
{
    ...
    private static void AppendSection2Methodology(StringBuilder body, KycReportComposeRequest request, SummaryStats stats)
    {
        ...
        body.AppendLine(
            "<li><strong>Motor de scoring (ContextMemory):</strong> com base no inventário de sinais e partes, cálculo do score global (0–100) e das dimensões: Sanções, PEP, Media adversa, Saúde financeira, Judicial e Estrutura UBO. Dimensões sem dados de fonte ficam como <em>n/d</em> (não inventadas).</li>");
        body.AppendLine(
