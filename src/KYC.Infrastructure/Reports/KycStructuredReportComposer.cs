...
public sealed class KycStructuredReportComposer : IKycReportComposer
{
    ...
    private static void AppendRegulatoryDisclosures(StringBuilder body, KycReportComposeRequest request)
    {
        ...
        body.AppendLine("<p>Scoring e narrativa assistidos por LLM via ContextMemory. Não substituem diligência humana. Dimensões não avaliadas automaticamente: intenção criminal, contexto sectorial completo, fontes não indexadas, alterações posteriores ao relatório.</p>");
