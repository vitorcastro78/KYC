...
> **Versão em português.** Espelho da documentação canónica em `docs/` (raiz) e `help-online/`.
>
...
| Idioma | Pasta |
|--------|--------|
| Português (esta pasta) | [`../pt/`](../pt/) + [`../help-online/pt/`](../help-online/pt/) |
...
## Especificações de origem (esta pasta de idioma)
...
Manual online (português): [../help-online/pt/](../help-online/pt/)
