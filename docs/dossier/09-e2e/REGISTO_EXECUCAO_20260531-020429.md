# Registo E2E automatizado â€” 20260531-020429

| Item | Ficheiro |
|------|----------|
| Resultados testes | docs/dossier/09-e2e/test-results-20260531-020429.trx |
| Export audit/casos | audit-export-20260531-010500.json |
| Audit trail | docs/dossier/08-audit/audit-trail-e2e-*.json |
| HTTP health/OpenAPI | docs/dossier/09-e2e/http-*-20260531-020429.txt |
| Webhook identidade | docs/dossier/06-identidade/webhook-*.txt |
| Testes aplicacao | docs/dossier/09-e2e/application-tests-20260531-020429.log |

Executado: 2026-05-31T02:05:19.9238999+01:00
...
|---|---------|-----------|-----------|
| 1 | PAC CAE 92000 | OK (teste) | test-results-20260531-020429.trx |
